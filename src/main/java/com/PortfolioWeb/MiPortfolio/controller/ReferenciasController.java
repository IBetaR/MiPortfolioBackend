...
import com.PortfolioWeb.MiPortfolio.service.ReferenciasService;
...
public class ReferenciasController {
    ...
    @ResponseBody
    public void crearReferencias (@RequestBody Referencias referencia){
        refServ.crearReferencias(referencia);
    }
